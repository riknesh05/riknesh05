Create a premium GitHub Profile README hero banner entirely in pure SVG.
The output MUST be responsive, optimized for GitHub, and look exactly like a high-end
developer profile.
========================
GENERAL LAYOUT
========================
...
RIGHT SIDE
Professional terminal window.Include:
Greeting
Hi 👋
I'm {NAME}
...
Sequential reveal
Cursor blinking
BackgroundFloating radial gradients
Noise texture
Moving scanline
...
ASCII
Blue → Cyan gradient.
Glow should be softer than dark mode.Background
...
========================
✔ Border shimmer
✔ Gradient movement✔ Floating particles
✔ Typing cursor
✔ Scanline sweep
✔ Glow pulse
✔ Sequential reveal
...
Generate TWO separate SVG files:1. dark.svg
2. light.svg
Both should have identical layout and animations while only changing the color palette to suit
dark and light GitHub themes.
